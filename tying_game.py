...
startingimage_rel = 'naruto-shippuden-4k (1).jpg'
backgroundimage_rel = 'bg_img.jpg'
essay_rel = 'text.txt'
icon_rel = 'return.png'

# Create absolute paths
startingimage = os.path.join(script_dir, startingimage_rel)
backgroundimage = os.path.join(script_dir, backgroundimage_rel)
essay = os.path.join(script_dir, essay_rel)
icon = os.path.join(script_dir, icon_rel)
